...
// QA review (commit 6cdd179): mirrors _session-logic.mjs's own coverage of
// the same immutability contract the deleted appendPlayerMoves test used to
// carry on the server-side copy.
